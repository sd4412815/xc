...
if ($time['ot_state'] == OrderTemp::STATE_READY && ($time['ot_position']-$time['ot_order_count'] > 0)){
	if ($time['ot_bias'] ==0 ){
...
<span class="zhe-box" data-text=""><i class="fa fa-jpy"></i>
    <?php
        if ($time['ot_value'] < 1 ){
...
//} ?>
<?php endforeach;?>
<?php Yii::app ()->clientScript->registerScript ( 'time_list', 'set_time_change_ini();', CClientScript::POS_READY );?>
