...
', //无数据时显示内容
 		'summaryCssClass'=>'summary_container contents grid-contents col-xs-12 col-sm-6',//定义summary的div容器的class
 		...
 		//{pages}表示总页数
 		'sortableAttributes'=>array('all'=>'综合排序','oh_state'=>'状态'),//定义可排序的属性
 		
 		'sorterCssClass'=>'sorter_container contents grid-contents col-md-12 col-xs-12',//定义sorter的div容器的class
