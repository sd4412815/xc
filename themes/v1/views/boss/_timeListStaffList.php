...
'itemView'=>'_timeListStaffListInfo',
...
<div class="alert alert-waning wide-fat green">没有找到车行信息！请选择您所在的省市地区！		
</div>
...
', //无数据时显示内容
 ...
 $('.sStaffListCheckbox input[name=\"staffCheckbox\"]').iCheck('check');	
                    		",CClientScript::POS_READY);
 ?>   