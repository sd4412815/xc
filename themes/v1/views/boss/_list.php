...
'itemView'=>'_orderInfo',
 		...
 		'template'=>'<div class="list"><table class="table table-bordered  text-center"><tr class="success "><th class="col-sm-1">服务</th>
 		
 		<th class="col-sm-2">车主</th><th class="col-sm-3">预约时间</th><th class="col-sm-1">金额</th><th class="col-sm-1">优惠</th><th class="col-sm-2">状态</th><th class="col-sm-2">操作</th>
