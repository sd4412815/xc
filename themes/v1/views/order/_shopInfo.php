...
<div class="content col-md-3 col-sm-12">
	...
	<div class="inner">
		...
		<a class="thumbnailz"
			...
			<img
			src="images/shops/<?php echo $data->id;?>/shop<?php echo $data->id;?>.jpg"
			alt="<?php echo $data->ws_name;?>" class="responsive-image" /> <span
			class="overlay">Details</span>
		...
		<div class="entry">
			...
			<article class="entry-content">
				...
				<h2 class="post-title">
					<a
						href="<?php echo  Yii::app()->createUrl('order/new',array('id'=>$data->id));?>"
						title="<?php echo $data->ws_name;?>"><?php echo $data->ws_name;?></a>
				</h2>
...
half:true,
	...
	?>    
			...
			<div class="entry-meta">
				...
				<span class="button green wide-fat"><a
					href="<?php echo  Yii::app()->createUrl('order/new',array('id'=>$data->id));?>"
					style="color: white;">去预定</a></span>
