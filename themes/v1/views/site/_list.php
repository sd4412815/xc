<?php
Yii::app()->clientScript->registerCssFile(Yii::app()->theme->baseUrl . "/inc/raty/jquery.raty.css", CClientScript::POS_HEAD);
Yii::app()->clientScript->registerScriptFile(Yii::app()->theme->baseUrl . "/inc/raty/jquery.raty.js", CClientScript::POS_HEAD);
