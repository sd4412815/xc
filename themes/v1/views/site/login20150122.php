...
echo CHtml::submitButton ( '登录', array (
	   ...
	   $url = array();
	   switch ($type){
	   	case '0':  $url = array('/user/reset');;break;
	   	case '1':   $url = array('/staff/reset');;break;
	   	case '2':   $url = array('/boss/reset');;break;
	   }
...
$this->widget ( 'bootstrap.widgets.TbButton', array (
	...
	$url = array();
	switch ($type){
		case '0':  $url = array('/user/reg');;break;
		case '1':   $url = array('/staff/reg');;break;
		case '2':   $url = array('/boss/reg');;break;
	}
$this->widget ( 'bootstrap.widgets.TbButton', array (
			'buttonType' => 'link',
			'type' => 'link',
