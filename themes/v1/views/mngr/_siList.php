...
'itemView'=>'_siInfo',
 		...
 		'template'=>'<div class="list"><table class="table table-hover"><tr> 
 		
 		<th>ID</th><th>服务小项</th><th>服务小项描述</th><th>费用</th><th>积分</th><th>用时</th><th>状态</th><th>城市标识</th>
...
', //无数据时显示内容
 ...
 ?>
   	...
   	<br />
   	<br />
				<?php if(Yii::app()->user->hasFlash('siUpdateSuccess')):?> 
<div class="alert alert-success alert-dismissable">
  <i class="fa fa-check"></i>
                                        <button type="button" class="close" data-dismiss="alert" aria-hidden="true">×</button>
<?php echo Yii::app()->user->getFlash('siUpdateSuccess'); ?> 
</div>
<?php endif; ?> 
				</div>
