...
'itemView'=>'_shopInfo',
 		...
 		'template'=>'<div><div class="table-responsive"><div class="sorter">{sorter}</div><table class="table table-hover">  <tr class="success"><th>加盟号</th>
<th>省</th><th>市</th><th >车行名称</th><th class="visible-lg">地址</th><th class="visible-lg">评分</th><th>级别</th><th>状态</th><th>加盟时间</th><th>服务时间</th>
										   <th>操作</th>
									  </tr>{items}</table></div></div><div class="pager">{pager}</div><div class="summary">{summary}</div>',
//  		'template'=>'<div class="list">{items}</div><div class="pager">{pager}</div><div class="summary">{summary}</div>',
...
', //无数据时显示内容
 		...
 		//{pages}表示总页数
 		'sortableAttributes'=>array('all'=>'综合','join'=>'加盟时间','state'=>'状态', 'level'=>'级别','score'=>'评分','province'=>'省','city'=>'市'),//定义可排序的属性
 		...
 		'pagerCssClass'=>'pager_container contents grid-contents ',//定义pager的div容器的class
 		'pager'=>array(
