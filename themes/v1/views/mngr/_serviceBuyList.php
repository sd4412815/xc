...
'itemView'=>'_serviceBuyInfo',

 		'template'=>'<div class="list"><table class="table table-hover"><tr><td>申请编号</td><td>车行</td>
 		<td>申请时间</td><td>申请类型</td><td>金额</td><td>时长</td><td>姓名</td><td>电话</td>
 		<td>状态</td><td>操作</td></tr>{items}</table></div><div class="pager">{pager}</div><div class="summary">{summary}</div>',
