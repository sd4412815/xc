 ...
 * </tr>
 * <tr valign="top">
 * CURLOPT_SSL_select class="form-control"PEER</td>
 * false to stop cURL from select class="form-control"ing the peer's
 * certificate. Alternate certificates to select class="form-control" against can be
 ...
 * </tr>
 * <tr valign="top">
 * CURLOPT_SSL_select class="form-control"HOST</td>
 * 1 to check the existence of a common name in the
 * SSL peer certificate. 2 to check the existence of
 * a common name and also select class="form-control" that it matches the hostname
 ...
 * <tr valign="top">
 * CURLOPT_CAINFO</td>
 * The name of a file holding one or more certificates to select class="form-control" the
 * peer with. This only makes sense when used in combination with
 * CURLOPT_SSL_select class="form-control"PEER.
 * </td>
 ...
 * alongside CURLOPT_SSL_select class="form-control"PEER.
 * </td>
 * </td>
 * </tr>
 * <tr valign="top">
 ...
 * "request_size"
 * "filetime"
 * "ssl_select class="form-control"_result"
 * "redirect_count"
 * "total_time"
 * "namelookup_time"
 * "connect_time"
...
define ('CURLOPT_SSL_select class="form-control"HOST', 81);
define ('CURLOPT_SSL_select class="form-control"PEER', 64);
...
define ('CURLINFO_SSL_select class="form-control"RESULT', 2097165);
